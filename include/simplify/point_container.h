...
template<concepts::point P = Point, template<class> class Container = std::vector>
polygon() -> polygon<P, direction::NA, Container>;
...
static inline geometry::Point operator-(const geometry::Point& p0) { return geometry::Point{ -p0.X, -p0.Y }; }
static inline geometry::Point operator+(const geometry::Point& p0, const geometry::Point& p1) { return geometry::Point{ p0.X + p1.X, p0.Y + p1.Y }; }
static inline geometry::Point operator-(const geometry::Point& p0, const geometry::Point& p1) { return geometry::Point{ p0.X-p1.X, p0.Y-p1.Y }; }
